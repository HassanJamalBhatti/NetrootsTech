...
const renderStars = (value: number) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      {/* Top Stats Bar */}
      <div className="w-full bg-blue-600 text-white shadow-lg">
        ...
        <div className="hidden sm:grid grid-cols-5 gap-6 py-10 px-6 sm:px-20">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center sm:border-r border-white gap-4 sm:gap-3">
            ...
            >
              ...
              <div className="leading-tight text-center sm:text-left">
                ...
                <p className="text-sm mt-1 opacity-90">{reviews.toLocaleString()} Reviews</p>
              </div>
            </a>
          </div>
          ...
          <div className="flex flex-col justify-center items-center sm:border-r border-white text-center">
            <p className="text-3xl font-bold">40% <span className="text-xl">Boost</span></p>
          ...
          {/* Projects Completed */}
          <div className="flex flex-col justify-center items-center sm:border-r border-white text-center">
            <p className="text-3xl font-bold">100+ <span className="text-xl">Projects</span></p>
        ...
        <div className="sm:hidden px-6 py-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-blue-500 rounded-md p-4 flex flex-col items-center">
              <p className="text-2xl font-bold">40% <span className="text-sm">Boost</span></p>
            ...
            <div className="bg-blue-500 rounded-md p-4 flex flex-col items-center">
              <p className="text-2xl font-bold">100+ <span className="text-sm">Projects</span></p>
